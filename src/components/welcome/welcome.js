  ...
  return (
    <div className="fullpage w-full h-screen snap-center text-white flex flex-col justify-center items-center relative" id="welcome">
      <div className="flex flex-col items-left">
        <p className=" mt-8 font-bold font-mono text-base md:text-2xl flex">Hi, Mein Name ist </p>
      ...
      <div className=" absolute h-32 w-full bottom-10 flex items-center justify-center flex-col">
        ...
        <p className=" font-bold font-mono text-sm md:text-lg mb-5">Scroll Down</p>
        <button onClick={
          ...
          <i class="fa-solid fa-arrow-down-long text-2xl md:text-4xl"></i>
        </button>
