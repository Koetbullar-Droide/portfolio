        ...
        <div className="p-0">
            ...
            <div className=" bg-gray-900 w-full text-white text-center flex justify-center items-center flex-col p-0" id="about">
                ...
                <div className=" lg:w-[60%] w-[85%] items-center flex flex-col">
                    ...
                    Ich bin gerade Schüler an der Oberstufe in Niederrohrdorf, gehe in die Bezirksschule und werde voraussichtlich im Sommer 2023 die Schule verlassen. Wie Sie hoffentlich auf dieser Website schon gesehen haben, beschäftige ich mich viel mit der Informatik. In meiner Freizeit liebe ich es Technik-Projekte voran zu treiben. Ausserdem spiele ich auch Badminton und betätige mich ehrenamtlich als Leitperson in der Cevi(Pfadfinder). In diesem schnell wachsenden Gebiet sehe ich auch meine Zukunft. Entschlossen möchte ich eine Lehre als Applikationsentwickler beginnen, um meine Neugierde zu stillen. Dabei möchte ich meine Kompetenzen stetig verbessern um am Ende eine soziale, kommunikative und kompetente Persönlichkeit mit weit umfassendem Wissen in der Informatik zu sein. Ich hoffe wir können dieses Ziel gemeinsam erreichen und auch beide davon profitieren. Verweilen Sie doch noch eine Weile auf dieser Website um sich zu vergewissern. Aber vergessen Sie nicht, mich auch zu kontaktieren, so dass wir uns bald persönlich kennen lernen.
                    </p>
